...
export const FAMILLES = [
  {
    ...
    emoji: "👟",
    glyphe: "boite",
    image: "/produits/marque-nike.svg",
    type: "produits",
    ...
    gammes: [
      {
        ...
        sousTitre: "",
        produits: [
          { ref: "NK-AF1", nom: "Air Force 1", unite: "la paire", prix: 119.9, dispo: true, tailles: "39 · 40 · 41 · 42 · 43 · 44 · 45", couleurs: "Blanc · Noir · Rouge", chef: true, image: "/produits/nk-af1.svg", 
          ...
          { ref: "NK-AM90", nom: "Air Max 90", unite: "la paire", prix: 149.9, dispo: true, tailles: "40 · 41 · 42 · 43 · 44", couleurs: "Gris · Blanc · Bleu marine", image: "/produits/nk-am90.svg", 
            description: "Bulle d'air visible, maille et daim." },
          { ref: "NK-DUNK", nom: "Dunk Low", unite: "la paire", prix: 129.9, dispo: true, tailles: "39 · 40 · 41 · 42 · 43 · 44", couleurs: "Noir · Blanc · Vert", image: "/produits/nk-dunk.svg", 
            description: "Coupe basse, tige en cuir deux tons." },
        ],
      },
    ],
  },
